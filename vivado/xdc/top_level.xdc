...
set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {io_clk_100mhz}]
create_clock -add -name gclk -period 10.000 -waveform {0 4} [get_ports {io_clk_100mhz}]
...
# USER GREEN LEDS
set_property -dict {PACKAGE_PIN C13  IOSTANDARD LVCMOS33} [ get_ports {io_led} ]
...
#
### USER PUSH BUTTON
set_property -dict {PACKAGE_PIN J2  IOSTANDARD LVCMOS33} [ get_ports "io_rst" ]
