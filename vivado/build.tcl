...
set sources_sv [ glob ./generated/*.sv ]
read_verilog -sv $sources_sv

# read in all (if any) verilog files:
set sources_v [ glob -nocomplain ./generated/*.v ]
...
#Run Synthesis
synth_design -top Top -part $partNum -verbose
...
report_clocks -file $outputDir/clockInfo.txt
